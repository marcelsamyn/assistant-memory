...
- \`create_node { tempId, label, description, type }\` — only if a referenced entity is genuinely missing. Set \`description\` to a short description, or null when none applies.
